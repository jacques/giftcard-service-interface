...
public abstract class LoadsResource {
   ...
   public final void confirmLoad(
         @ApiParam(value = "The randomly generated loadId UUID as sent in the original load.", required = true) @PathParam("loadId") UUID loadId,
   ...
   public final void load(
         @ApiParam(value = "The randomly generated UUID identifying this load, as defined for a variant 4 UUID in [RFC 4122](https://tools.ietf.org/html/rfc4122).", required = true) @PathParam("loadId") UUID loadId,
